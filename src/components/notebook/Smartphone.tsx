...
const Smartphone = () => {
  ...
  return (
    <div className="relative flex items-center justify-center w-full max-w-[280px] xs:max-w-[320px] aspect-[9/19] perspective-1000 scale-100 transition-transform duration-500">
      {/* Phone Container */}
      <motion.div 
