    ...
    <div className="h-full w-full bg-[#020617] text-slate-300 font-mono text-[9px] md:text-sm overflow-hidden flex flex-col border border-slate-800/50 rounded-sm">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        ...
        <ScrollArea className="flex-1 bg-[#020617]">
          <div className="p-3 md:p-10 max-w-full md:max-w-3xl mx-auto overflow-x-hidden">
            ...
            >
              ...
              <div className="text-center md:text-left min-w-0 w-full">
                <div className="flex items-center justify-center md:justify-start gap-2 mb-1 md:mb-2">
                  <h1 className="text-sm md:text-3xl font-black text-white tracking-tight truncate">Kevin de Santana Carvalho</h1>
                  <Monitor size={12} className="text-blue-400 animate-pulse md:w-5 md:h-5 shrink-0" />
                </div>
                <p className="text-blue-400 font-medium mb-3 md:mb-4 text-[9px] md:text-lg truncate">Software Engineering Student</p>
                <div className="flex flex-wrap justify-center md:justify-start gap-1.5 md:gap-2">
                  <Badge className="bg-blue-500/10 text-blue-400 border-blue-500/20 text-[7px] md:text-xs px-1.5 py-0 md:px-2.5 md:py-0.5">Fullstack</Badge>
            ...
            {/* Code Block Section */}
            <section className="mb-8 md:mb-12 bg-slate-900/30 p-3 md:p-6 rounded-lg border border-slate-800/50 backdrop-blur-sm overflow-hidden w-full">
              ...
              <div className="pl-3 md:pl-8 space-y-1.5">
                {codeLines.map((line, idx) => (
                  <motion.div 
                    ...
                    className="flex items-start gap-2 md:gap-4 text-[8px] md:text-sm w-full"
                  >
                    <span className="text-slate-600 w-3 md:w-4 shrink-0">{idx + 2}</span>
                    <span className="text-blue-300 shrink-0">{line.label}:</span>
                    <span className={`${line.color} break-all md:break-words`}>{line.value}</span>
                  </motion.div>
                ))}
              </div>
            ...
            <section className="mb-8 md:mb-12 w-full">
              ...
              <div className="space-y-4 text-slate-400 leading-relaxed text-[9px] md:text-base w-full">
                <p>
            ...
            <section ref={projectsRef} className="mb-8 md:mb-12 w-full">
              ...
              <div className="space-y-6 w-full">
                ...
                <div className="p-4 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 hover:border-blue-500/50 transition-colors group w-full">
                  <div className="flex justify-between items-start mb-3 md:mb-4 gap-2">
                    <div className="min-w-0">
                      <h3 className="font-bold text-[10px] md:text-xl text-blue-400 group-hover:text-blue-300 transition-colors truncate">LinkStudio</h3>
                      <p className="text-[8px] md:text-sm text-slate-500 truncate">Plataforma de Agendamento Web</p>
                    </div>
                    <a href="https://www.linkstudio.com.br/" target="_blank" rel="noopener noreferrer" className="p-2 bg-slate-800 rounded-full hover:bg-blue-600 transition-colors shrink-0">
                      <ExternalLink size={12} className="text-white md:w-4 md:h-4" />
                    </a>
                  </div>
                  <p className="text-[9px] md:text-base text-slate-300 mb-4 break-words">
                ...
                <div className="p-4 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 hover:border-orange-500/50 transition-colors group w-full">
                  <div className="flex justify-between items-start mb-3 md:mb-4 gap-2">
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <h3 className="font-bold text-[10px] md:text-xl text-orange-400 group-hover:text-orange-300 transition-colors truncate">Jornada Espacial</h3>
                        <Coffee size={14} className="text-orange-500 md:w-5 md:h-5 shrink-0" />
                      </div>
                      <p className="text-[8px] md:text-sm text-slate-500 truncate">Projeto em Java – Faculdade (POO)</p>
                    </div>
                    <a href="https://github.com/KevinSan87/Jornada-Espacial" target="_blank" rel="noopener noreferrer" className="p-2 bg-slate-800 rounded-full hover:bg-orange-600 transition-colors shrink-0">
            ...
            <section ref={stackRef} className="mb-8 md:mb-12 w-full">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-4 w-full">
                {stack.map((tech) => (
                  <div key={tech} className="flex items-center gap-2 p-2 md:p-3 rounded-lg bg-slate-900/50 border border-slate-800/50 text-[8px] md:text-sm text-slate-300 hover:bg-slate-800/50 transition-colors min-w-0">
                    <div className="w-1.5 h-1.5 bg-blue-500 rounded-full shadow-[0_0_8px_rgba(59,130,246,0.5)] shrink-0"></div>
            ...
            <section ref={activityRef} className="mb-8 md:mb-12 w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 w-full">
                <div className="p-4 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col items-start gap-2 group hover:border-emerald-500/30 transition-all w-full">
                ...
                <div className="p-4 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col items-start gap-2 group hover:border-blue-500/30 transition-all w-full">
                ...
                <div className="p-4 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col items-start gap-2 group hover:border-purple-500/30 transition-all w-full">
              ...
              <div className="p-4 md:p-6 rounded-xl border border-slate-800 bg-[#0f172a] overflow-hidden relative w-full">
                <div className="flex flex-col gap-4 w-full">
                  <div className="flex items-center justify-between w-full">
                    <div className="flex items-center gap-2 min-w-0">
                      <Github size={14} className="text-slate-400 shrink-0" />
                      <span className="text-[8px] md:text-sm text-slate-300 font-bold truncate">@KevinSan87</span>
                    </div>
                  ...
                  <div className="flex justify-between items-center w-full gap-2">
                    <span className="text-[7px] md:text-[10px] text-slate-500 italic truncate">Last 12 months</span>
                    <div className="flex items-center gap-2 md:gap-4 text-[7px] md:text-[10px] text-slate-500 shrink-0">
            ...
            {/* Contact Section */}
            <section ref={contactRef} className="pb-6 md:pb-12 w-full">
