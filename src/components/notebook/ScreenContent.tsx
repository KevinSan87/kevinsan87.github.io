        ...
        <ScrollArea className="flex-1 bg-[#020617]">
          <div className="p-2 md:p-10 max-w-3xl mx-auto overflow-x-hidden">
            ...
            <section className="mb-6 md:mb-12 bg-slate-900/30 p-2 md:p-6 rounded-lg border border-slate-800/50 backdrop-blur-sm overflow-hidden">
              ...
              <div className="pl-1.5 md:pl-8 space-y-1">
            ...
            <section className="mb-6 md:mb-12">
              <h2 className="text-[10px] md:text-xl font-bold text-white mb-3 md:mb-6 flex items-center gap-1.5">
                ...
                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 hover:border-orange-500/50 transition-colors group">
                  <div className="flex justify-between items-start mb-2 md:mb-4">
                    <div>
                      ...
                      <p className="text-[7px] md:text-sm text-slate-500">Java – Faculdade</p>
                    </div>
                  ...
                  <p className="text-[8px] md:text-base text-slate-300 mb-3">
                    Aplicação Java focada em POO e lógica de sistema.
                  </p>
                  <div className="flex flex-wrap gap-1 md:gap-2">
            ...
            <section ref={activityRef} className="mb-6 md:mb-12">
              ...
              <div className="grid grid-cols-1 gap-2 mb-4">
                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col items-start gap-1">
              ...
              <div className="p-2 md:p-6 rounded-xl border border-slate-800 bg-[#0f172a] overflow-hidden">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="w-full overflow-x-auto pb-1 scrollbar-hide">
                    <img 
                      ...
                      alt="GitHub Chart"
                      className="w-full min-w-0 h-auto filter invert-[0.85] hue-rotate-[140deg] brightness-[0.6] contrast-[1.4] mix-blend-screen"
                    />
                  </div>
                  
                  <div className="flex justify-between items-center">
                    <span className="text-[6px] md:text-[10px] text-slate-500 italic">Last 12 months</span>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section ref={contactRef} className="pb-4 md:pb-12">
              <div className="flex flex-wrap gap-1.5 md:gap-4">
                <a href="https://github.com/KevinSan87" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-2 py-1 md:px-5 md:py-2.5 rounded-full bg-slate-800 text-white text-[7px] md:text-sm">
                  <Github size={10} /> GitHub
                </a>
                <a href="mailto:Kevindesantana87@gmail.com" className="flex items-center gap-1.5 px-2 py-1 md:px-5 md:py-2.5 rounded-full bg-blue-600 text-white text-[7px] md:text-sm">
