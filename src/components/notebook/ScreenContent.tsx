  ...
  return (
    <div className="h-full w-full bg-[#020617] text-slate-300 font-mono text-[8px] md:text-sm overflow-hidden flex flex-col border border-slate-800/50 rounded-sm">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="w-full md:w-14 bg-[#0f172a] border-b md:border-b-0 md:border-r border-slate-800/50 flex flex-row md:flex-col items-center justify-center md:justify-start py-1 md:py-3 gap-3 md:gap-6 text-slate-500 shrink-0">
          ...
          <div className="p-2 md:p-10 max-w-3xl mx-auto overflow-x-hidden">
            ...
            >
              ...
              <div className="text-center md:text-left">
                <h1 className="text-[11px] md:text-3xl font-black text-white tracking-tight mb-0.5">Kevin de Santana Carvalho</h1>
            ...
            {/* Code Block Section */}
            <section className="mb-6 md:mb-12 bg-slate-900/30 p-2 md:p-6 rounded-lg border border-slate-800/50 overflow-hidden">
              ...
              <div className="pl-1 md:pl-8 space-y-1">
            ...
            <section className="mb-6 md:mb-12">
              ...
              <div className="space-y-3 text-slate-400 leading-relaxed text-[8px] md:text-base">
                <p>Estudante de Software com foco em Backend. Experiência em regras de negócio e modelagem de banco de dados.</p>
                <ul className="grid grid-cols-1 gap-1.5 pl-1">
                  {['Lógica de negócio', 'Banco de Dados Relacional', 'Integração Fullstack'].map((item) => (
            ...
            <section ref={projectsRef} className="mb-6 md:mb-12">
              ...
              <div className="space-y-4">
                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40">
                  ...
                  <p className="text-[8px] md:text-base text-slate-300 mb-3">Plataforma de Agendamento Web completa.</p>
            ...
            <section ref={stackRef} className="mb-6 md:mb-12">
              ...
              <div className="grid grid-cols-2 gap-1.5 md:gap-4">
                {stack.slice(0, 6).map((tech) => (
                  <div key={tech} className="flex items-center gap-1.5 p-1.5 rounded-lg bg-slate-900/50 border border-slate-800/50 text-[7px] md:text-sm text-slate-300">
            ...
            <section ref={activityRef} className="mb-6 md:mb-12">
              ...
              <div className="grid grid-cols-1 gap-2 mb-4">
                <div className="p-3 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col gap-1">
                  <span className="text-[6px] font-bold uppercase text-emerald-400/60">Contributions</span>
                  <span className="text-lg font-black text-white">{githubStats.contributions}</span>
                </div>
              </div>

              <div className="p-2 rounded-xl border border-slate-800 bg-[#0f172a] overflow-hidden">
                <div className="w-full overflow-x-auto pb-1 scrollbar-hide">
                  <img 
                    src="https://ghchart.rshah.org/39d353/KevinSan87" 
                    alt="GitHub Chart"
                    className="min-w-[280px] w-full h-auto filter invert-[0.85] hue-rotate-[140deg] brightness-[0.6] contrast-[1.4] mix-blend-screen"
                  />
                </div>
              </div>
            </section>
      ...
      {/* Footer Bar */}
      <div className="bg-blue-600 text-white px-1.5 md:px-4 py-0.5 md:py-1.5 flex items-center justify-between text-[5px] md:text-[10px] font-bold shrink-0">
