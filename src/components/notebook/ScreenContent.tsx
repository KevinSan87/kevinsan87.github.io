    ...
    <div className="h-full w-full bg-[#020617] text-slate-300 font-mono text-[9px] md:text-sm overflow-hidden flex flex-col border border-slate-800/50 rounded-sm">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden min-h-0">
        ...
        <div className="w-full md:w-14 bg-[#0f172a] border-b md:border-b-0 md:border-r border-slate-800/50 flex flex-row md:flex-col items-center justify-center md:justify-start py-1.5 md:py-3 gap-4 md:gap-6 text-slate-500 shrink-0">
          <button onClick={() => scrollToSection(aboutRef)} className="p-1 md:p-2 hover:bg-slate-800/50 rounded-md hover:text-blue-400 transition-colors">
            <User size={12} className="md:w-[18px] md:h-[18px]" />
          </button>
          <button onClick={() => scrollToSection(projectsRef)} className="p-1 md:p-2 hover:bg-slate-800/50 rounded-md hover:text-blue-400 transition-colors">
            <Layers size={12} className="md:w-[18px] md:h-[18px]" />
          </button>
          <button onClick={() => scrollToSection(stackRef)} className="p-1 md:p-2 hover:bg-slate-800/50 rounded-md hover:text-blue-400 transition-colors">
            <Database size={12} className="md:w-[18px] md:h-[18px]" />
          </button>
          <button onClick={() => scrollToSection(activityRef)} className="p-1 md:p-2 hover:bg-slate-800/50 rounded-md hover:text-blue-400 transition-colors">
            <Activity size={12} className="md:w-[18px] md:h-[18px]" />
          </button>
          <button onClick={() => scrollToSection(contactRef)} className="p-1 md:p-2 hover:bg-slate-800/50 rounded-md hover:text-blue-400 transition-colors">
            <Github size={12} className="md:w-[18px] md:h-[18px]" />
          </button>
        </div>

        {/* Main Editor Area */}
        <ScrollArea className="flex-1 bg-[#020617] min-h-0 w-full">
          <div className="p-3 md:p-10 max-w-full md:max-w-3xl mx-auto overflow-x-hidden">
            ...
            <section className="mb-8 md:mb-12 w-full">
              ...
              <div className="space-y-3 text-slate-400 leading-relaxed text-[8px] md:text-base w-full">
                <p>
            ...
            <section ref={stackRef} className="mb-8 md:mb-12 w-full">
              ...
              <div className="grid grid-cols-2 gap-2 md:gap-4 w-full">
                {stack.map((tech) => (
                  <div key={tech} className="flex items-center gap-1.5 p-1.5 md:p-3 rounded-lg bg-slate-900/50 border border-slate-800/50 text-[7px] md:text-sm text-slate-300 hover:bg-slate-800/50 transition-colors truncate">
            ...
            <section ref={activityRef} className="mb-8 md:mb-12 w-full">
              ...
              <div className="grid grid-cols-1 gap-3 mb-4 w-full">
                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col items-start gap-1 group hover:border-emerald-500/30 transition-all w-full">
                ...
                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col items-start gap-1 group hover:border-blue-500/30 transition-all w-full">
              ...
              <div className="p-2 md:p-6 rounded-xl border border-slate-800 bg-[#0f172a] overflow-hidden relative w-full">
                <div className="flex flex-col gap-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1.5">
                      <Github size={10} className="text-slate-400" />
                      <span className="text-[7px] md:text-sm text-slate-300 font-bold truncate">@KevinSan87</span>
                    </div>
                  </div>
            ...
            <section ref={contactRef} className="pb-20 md:pb-12 w-full">
              <div className="flex flex-wrap gap-1.5 md:gap-4 justify-center md:justify-start">
                <a href="https://github.com/KevinSan87" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-full bg-slate-800 hover:bg-slate-700 text-white text-[7px] md:text-sm transition-all">
                  <Github size={10} className="md:w-4 md:h-4" /> GitHub
                </a>
                <a href="mailto:Kevindesantana87@gmail.com" className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-full bg-blue-600 hover:bg-blue-500 text-white text-[7px] md:text-sm transition-all">
