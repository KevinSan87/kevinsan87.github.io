  ...
  return (
    <div className="h-full w-full bg-[#020617] text-slate-300 font-mono text-[9px] md:text-sm overflow-hidden flex flex-col border border-slate-800/50 rounded-sm">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Sidebar */}
        <div className="w-7 md:w-14 bg-[#0f172a] border-r border-slate-800/50 flex flex-col items-center py-3 gap-3 md:gap-6 text-slate-500">
          <button 
        ...
        <ScrollArea className="flex-1 bg-[#020617]">
          <div className="p-2.5 md:p-10 max-w-3xl mx-auto overflow-x-hidden">
            ...
            >
              ...
              <div className="text-center md:text-left">
                <div className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-1 mb-1 md:mb-2">
                ...
                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 hover:border-blue-500/50 transition-colors group">
                  <div className="flex justify-between items-start mb-2 md:mb-4">
                    <div>
                      ...
                      <p className="text-[7px] md:text-sm text-slate-500">Agendamento Web</p>
                    </div>
                ...
                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 hover:border-orange-500/50 transition-colors group">
                  <div className="flex justify-between items-start mb-2 md:mb-4">
                    <div>
                      ...
                      <p className="text-[7px] md:text-sm text-slate-500">Java – Faculdade (POO)</p>
                    </div>
              ...
              <div className="grid grid-cols-2 gap-1.5 md:gap-4">
                {stack.map((tech) => (
                  <div key={tech} className="flex items-center gap-1.5 p-1.5 md:p-3 rounded-lg bg-slate-900/50 border border-slate-800/50 text-[7px] md:text-sm text-slate-300 hover:bg-slate-800/50 transition-colors">
                    <div className="w-1 h-1 bg-blue-500 rounded-full shadow-[0_0_8px_rgba(59,130,246,0.5)]"></div>
                    {tech}
                  </div>
                ))}
              </div>
            ...
            <section ref={activityRef} className="mb-6 md:mb-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mb-4">
                <div className="p-2.5 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col items-start gap-1 group hover:border-emerald-500/30 transition-all">
                  ...
                  <span className="text-xs md:text-3xl font-black text-white">{githubStats.contributions}</span>
                </div>

                <div className="p-2.5 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col items-start gap-1 group hover:border-blue-500/30 transition-all">
                  ...
                  <span className="text-xs md:text-3xl font-black text-white">{githubStats.repos}+</span>
                </div>
              </div>

              <div className="p-2.5 md:p-6 rounded-xl border border-slate-800 bg-[#0f172a] overflow-hidden relative">
