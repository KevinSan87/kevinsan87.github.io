          ...
          <div className="px-2 py-4 md:p-10 max-w-full md:max-w-3xl mx-auto overflow-x-hidden">
            ...
            >
              ...
              <div className="text-center md:text-left min-w-0 w-full">
                ...
                <p className="text-blue-400 font-medium mb-3 md:mb-4 text-[8px] md:text-lg truncate">Software Engineering Student</p>
            ...
            <section ref={stackRef} className="mb-8 md:mb-12 w-full">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-1.5 md:gap-4">
                {stack.map((tech) => (
                  <div key={tech} className="flex items-center gap-1.5 p-1.5 md:p-3 rounded-lg bg-slate-900/50 border border-slate-800/50 text-[7px] md:text-sm text-slate-300 hover:bg-slate-800/50 transition-colors min-w-0">
                    <div className="w-1 h-1 bg-blue-500 rounded-full shrink-0 shadow-[0_0_8px_rgba(59,130,246,0.5)]"></div>
            ...
            <section ref={activityRef} className="mb-8 md:mb-12 w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4 mb-4">
                ...
                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col items-start gap-1 group hover:border-purple-500/30 transition-all w-full">
              ...
              <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-[#0f172a] overflow-hidden w-full">
