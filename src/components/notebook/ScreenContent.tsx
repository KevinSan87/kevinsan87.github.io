  ...
  return (
    <div className="h-full w-full bg-[#020617] text-slate-300 font-mono text-[8px] md:text-sm overflow-hidden flex flex-col border border-slate-800/50 rounded-sm">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Sidebar */}
        <div className="w-8 md:w-14 bg-[#0f172a] border-r border-slate-800/50 flex flex-col items-center py-3 gap-3 md:gap-6 text-slate-500 shrink-0">
          <button 
          ...
          <div className="p-3 md:p-10 max-w-3xl mx-auto overflow-x-hidden">
            ...
            >
              <div className="relative group shrink-0">
                ...
                <Avatar className="h-14 w-14 md:h-32 md:w-32 border-2 border-slate-800 relative z-10 overflow-hidden">
                  ...
                  />
                  <AvatarFallback className="bg-slate-900 text-slate-400 text-[10px] md:text-2xl">KC</AvatarFallback>
                </Avatar>
              ...
              <div className="text-center md:text-left min-w-0">
                <div className="flex items-center justify-center md:justify-start gap-1.5 mb-1 md:mb-2">
                  <h1 className="text-[11px] md:text-3xl font-black text-white tracking-tight leading-tight">Kevin de Santana Carvalho</h1>
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-1 md:gap-2">
                  <Badge className="bg-blue-500/10 text-blue-400 border-blue-500/20 text-[6px] md:text-xs px-1 md:px-2.5 py-0 md:py-0.5">Fullstack Development</Badge>
                  <Badge className="bg-purple-500/10 text-purple-400 border-purple-500/20 text-[6px] md:text-xs px-1 md:px-2.5 py-0 md:py-0.5">Always Learning 🚀</Badge>
                </div>
              </div>
            </motion.div>

            {/* Code Block Section */}
            <section className="mb-8 md:mb-12 bg-slate-900/30 p-2.5 md:p-6 rounded-lg border border-slate-800/50 backdrop-blur-sm overflow-hidden">
            ...
            <section className="mb-8 md:mb-12">
              ...
              <div className="space-y-3 text-slate-400 leading-relaxed text-[8px] md:text-base">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-1.5 md:gap-2 pl-1">
                  {[
            ...
            <section ref={projectsRef} className="mb-8 md:mb-12">
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 hover:border-blue-500/50 transition-colors group">
                  <div className="flex justify-between items-start mb-2 md:mb-4">
                    <div className="min-w-0">
                      <h3 className="font-bold text-[9px] md:text-xl text-blue-400 group-hover:text-blue-300 transition-colors truncate">LinkStudio</h3>
                      <p className="text-[7px] md:text-sm text-slate-500">Plataforma de Agendamento Web</p>
                    </div>
                    <a href="https://www.linkstudio.com.br/" target="_blank" rel="noopener noreferrer" className="p-1.5 md:p-2 bg-slate-800 rounded-full hover:bg-blue-600 transition-colors shrink-0">
                      <ExternalLink size={10} className="text-white md:w-4 md:h-4" />
                    </a>
                  </div>
                  <p className="text-[8px] md:text-base text-slate-300 mb-3 md:mb-4">
                    Desenvolvimento de uma aplicação web completa para gerenciamento de agendamentos.
                  </p>
                  <div className="space-y-1.5 md:space-y-2">
                    <p className="text-[7px] md:text-sm font-bold text-slate-400 uppercase tracking-wider">Responsabilidades:</p>
                ...
                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 hover:border-orange-500/50 transition-colors group">
                  <div className="flex justify-between items-start mb-2 md:mb-4">
                    <div className="min-w-0">
                      <div className="flex items-center gap-1.5">
                        <h3 className="font-bold text-[9px] md:text-xl text-orange-400 group-hover:text-orange-300 transition-colors truncate">Jornada Espacial</h3>
                        <Coffee size={10} className="text-orange-500 md:w-5 md:h-5 shrink-0" />
                      </div>
                      <p className="text-[7px] md:text-sm text-slate-500">Projeto em Java – Faculdade (POO)</p>
                    </div>
                    <a href="https://github.com/KevinSan87/Jornada-Espacial" target="_blank" rel="noopener noreferrer" className="p-1.5 md:p-2 bg-slate-800 rounded-full hover:bg-orange-600 transition-colors shrink-0">
                  ...
                  <div className="space-y-1.5 md:space-y-2">
                    <p className="text-[7px] md:text-sm font-bold text-slate-400 uppercase tracking-wider">Conceitos Aplicados:</p>
                    <div className="flex flex-wrap gap-1 md:gap-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-1.5 md:gap-4">
                {stack.map((tech) => (
                  <div key={tech} className="flex items-center gap-1.5 p-1.5 md:p-3 rounded-lg bg-slate-900/50 border border-slate-800/50 text-[7px] md:text-sm text-slate-300 hover:bg-slate-800/50 transition-colors">
                    <div className="w-1 h-1 md:w-1.5 md:h-1.5 bg-blue-500 rounded-full shadow-[0_0_8px_rgba(59,130,246,0.5)] shrink-0"></div>
            ...
            <section ref={activityRef} className="mb-8 md:mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-4 md:mb-6">
                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col items-start gap-1.5 md:gap-2 group hover:border-emerald-500/30 transition-all">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[6px] md:text-[10px] text-slate-500 font-medium">Contributions (Last Year)</span>
                  </div>
                </div>

                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col items-start gap-1.5 md:gap-2 group hover:border-blue-500/30 transition-all">
                  <div className="flex items-center gap-1.5 text-blue-400/60 group-hover:text-blue-400 transition-colors">
                    <GitBranch size={12} />
                    <span className="text-[6px] md:text-[10px] font-bold uppercase tracking-widest">Repositories</span>
                  </div>
                  <div className="flex flex-col">
                ...
                <div className="p-3 md:p-6 rounded-xl border border-slate-800 bg-slate-900/40 flex flex-col items-start gap-1.5 md:gap-2 group hover:border-purple-500/30 transition-all">
                  ...
                  <div className="flex flex-col">
                    <span className="text-lg md:text-3xl font-black text-white">Active</span>
                ...
                <div className="flex flex-col gap-3 md:gap-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 md:gap-3">
                      <div className="flex items-center gap-1 text-[6px] md:text-[10px] text-slate-500">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-[6px] md:text-[10px] text-slate-500 italic">Last 12 months of activity</span>
                    <div className="flex items-center gap-2 md:gap-4 text-[6px] md:text-[10px] text-slate-500">
                      <div className="flex items-center gap-1">
                        <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-slate-800 rounded-sm"></div>
                        <span>Less</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <div className="w-1.5 h-1.5 bg-[#39d35333] rounded-sm"></div>
                        <div className="w-1.5 h-1.5 bg-[#39d35366] rounded-sm"></div>
                        <div className="w-1.5 h-1.5 bg-[#39d353aa] rounded-sm"></div>
                        <div className="w-1.5 h-1.5 bg-[#39d353] rounded-sm"></div>
                        <span>More</span>
                      </div>
                    </div>
                  </div>
            ...
            <section ref={contactRef} className="pb-6 md:pb-12">
              <div className="flex flex-wrap gap-2 md:gap-4 justify-center md:justify-start">
                <a href="https://github.com/KevinSan87" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-3 py-1.5 md:px-5 md:py-2.5 rounded-full bg-slate-800 hover:bg-slate-700 text-white text-[7px] md:text-sm transition-all hover:scale-105">
                  <Github size={10} className="md:w-4 md:h-4" /> GitHub
                </a>
                <a href="mailto:Kevindesantana87@gmail.com" className="flex items-center gap-1.5 px-3 py-1.5 md:px-5 md:py-2.5 rounded-full bg-blue-600 hover:bg-blue-500 text-white text-[7px] md:text-sm transition-all hover:scale-105">
                  <Mail size={10} className="md:w-4 md:h-4" /> Contato
                </a>
                <a href="https://www.linkstudio.com.br/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-3 py-1.5 md:px-5 md:py-2.5 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white text-[7px] md:text-sm transition-all hover:scale-105">
                  <Globe size={10} className="md:w-4 md:h-4" /> LinkStudio
                </a>
              </div>
            </section>
          </div>
